                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-charcoal/70 text-lg leading-relaxed max-w-3xl mx-auto">
                            Un mariage oriental est unique. Les tenues de la Ziana, l'entrée majestueuse en Amaria, les rythmes envoûtants de la Dakka Marrakchia... En tant que <strong>photographe et vidéaste spécialisés dans le mariage maghrébin à Paris et en Île-de-France</strong>, Studio Riad comprend et anticipe ces moments cruciaux pour vous offrir des souvenirs à la hauteur de votre célébration.
                        </p>
                    </div>
